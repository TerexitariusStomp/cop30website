...
export const translations: Record<Lang, Dict> = {
  en: {
    ...
    "intro.p1":
      "AMAzone COOP30 is a Temporary Autonomous Zone (TAZ) located in the FREEzone, in Praça da Bandeira, in Belém (PA), from November 14th to 22nd, 2025. It is a space for free interaction and cultural expression, where the Spirit of Dialogue and Time will be our masters for nine days. Through discussion circles and the co-creation of regenerative solutions, we will slow down our daily rush to attune to inner voices, embrace feelings, and rebuild connections with one another and Nature. We will bring together cooperatives, associations, startups, artists, activists, scientists, entrepreneurs, impact investors, and traditional communities in an experience of self-management, cooperation, renewal, innovation, and a culture of P.E.A.C.E. AMAzone — here integrity is the axis, autonomy is the path, renewal is the destination, and love is the law.",
    "intro.p1.span": "",
    "intro.quote": "",
