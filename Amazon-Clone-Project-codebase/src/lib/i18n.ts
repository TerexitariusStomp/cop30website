...
export const translations: Record<Lang, Dict> = {
  en: {
    ...
    "platform.image.alt": "AMAzona network platform",
  ...
  pt: {
    ...
    "axes.3": "Bioconomia Circular, Comuns, Gestão Holística, Minimalismo & Pós-Crescimento",
    ...
    "activities.lead":
      "A AMAzone COOP30 é um encontro imersivo que une corpo, mente e espírito, ciência e arte, ancestralidade e tecnologia. Durante o evento, teremos:",
    "activities.group.learning": "Aprendizagem & Conhecimento",
    "activities.group.showcase": "Mostra & Inovação",
    ...
    "activities.item.4": "Feiras, exposições e showcases",
    ...
    "location.venue.line1": "Local: Espaço Nautiko – Beira do Rio Guamá, Belém (PA) – ao lado da UFPA",
    "location.venue.line2":
      "O espaço será uma TAZ (Zona Autônoma Temporária) viva, com camping, glamping, palco principal, restaurantes, galeria de arte, tenda de bem-estar, plenária, estandes de exposição, arte multimídia e áreas comunitárias. O local contará com ",
    ...
    "location.item.2": "Vila Indígena & Vila do Amor",
    ...
    // Deliverables
    "deliverables.title": "Entregáveis e Legado",
    "deliverable.1.title": "Think & DAO Tank AMAzone",
    "deliverable.1.desc": "Governança descentralizada do ecossistema",
    "deliverable.2.title": "Confederação Regenerativa de G.A.I.A",
    "deliverable.2.desc": "(Grande Aliança por Integridade e Autonomia) — Rede de cooperativas, associações e movimentos",
    "deliverable.3.title": "Créditos BiomaH",
    "deliverable.3.desc": "Nova métrica e ativo baseados na gestão holística da terra e em dados minerados por humanos e IA",
    "deliverable.4.title": "Rede de Guardiões da AMAzone",
    "deliverable.4.desc": "Formação e certificação de líderes regenerativos para proteger e originar créditos BiomaH e ativos verdes",
    "deliverable.5.title": "Cartografia AMAzone – Arquivo Vivo das Comunidades da Amazônia",
    "deliverable.5.desc": "Dados, arte, medicinas e histórias dos territórios amazônicos",

    // Pricing (headers only; rows handled in component)
    ...
    // Codex
    "codex.title": "CÓDICE AMAzone COOP30",
    "codex.subtitle": "17 A.D.A.s – Acordos para o Desenvolvimento Autônomo",
    "codex.p1":
      "AMAzone é nossa Vila do Amor. Acreditamos que todo sistema vivo — seja uma floresta, uma comunidade ou um código — precisa de princípios para manter sua harmonia. Assim como Burning Man estabeleceu seus 10 Princípios para sustentar uma cultura de autonomia e expressão, e os Toltecas deixaram seus 5 Acordos como caminho para a integridade interna, apresentamos os 17 A.D.A.s – Acordos para o Desenvolvimento Autônomo: nossos ODS do Amor, a base ética e energética que sustenta a Vila.",
    "codex.p2":
      "Os A.D.A.s são o código do software humano e social que opera dentro do território. Eles nos lembram como agir, falar, criar e conviver em um espaço de liberdade, cuidado e corresponsabilidade. Para que a Zona Temporária de Amor e Autonomia (T.A.Z.) funcione em paz e inteireza, é essencial que cada pessoa esteja atenta e consciente desses acordos, pois é por meio deles que a Vila vibra em harmonia, beleza e verdade.",
    "codex.list.1": "Inclusão Radical – Todas as pessoas são bem-vindas. A diversidade é força, não separação.",
    "codex.list.2": "Dom – Dar é a base da abundância. A generosidade cria vínculos e fortalece o espírito coletivo.",
    "codex.list.3": "Autossuficiência Radical – Cada pessoa é responsável por si. A autonomia começa na confiança interior.",
    "codex.list.4": "Autoexpressão Radical – Ser autêntico é honrar sua alma. Expressar-se com verdade é liberdade.",
    "codex.list.5": "Esforço Comunal – Nada floresce sozinho. Tudo o que existe na Vila é construído coletivamente.",
